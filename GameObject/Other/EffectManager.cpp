...
void EffectManager::Add(string key, UINT poolCount, wstring file, UINT frameX, UINT frameY, UINT nActions, float updateTime)
{
	...
	{
		effects.push_back(new Effect(file, frameX, frameY, nActions, updateTime));
	}
